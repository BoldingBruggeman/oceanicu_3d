...
def print_cfg(cfg):
    ...
    print(f"  Source:         {cfg.initial_conditions.source}")
    print(f"  Folder:         {cfg.initial_conditions.folder}")
    print(f"  Temperature:    {cfg.initial_conditions.temp}")
    print(f"  Salinity:       {cfg.initial_conditions.salt}")
