...
#    print(f"  Output folder:  {cfg.runtime.output_folder}")
    ...
    print(f"  Meteo:          {cfg.output.meteo}")
    print(f"  Tides:          {cfg.output.tides}")
    print(f"  Barotropic:")
    print(f"    default_2d:   {cfg.output.barotropic.default_2d}")
    print(f"    default_3d:   {cfg.output.barotropic.default_3d}")
    print(f"  Baroclinic:")
    print(f"    default:      {cfg.output.baroclinic.default}")
    print(f"    daily:")
    print(f"      surface:    {cfg.output.baroclinic.daily.surface}")
    print(f"      bottom:     {cfg.output.baroclinic.daily.bottom}")
    print(f"    monthly:      {cfg.output.baroclinic.monthly}")
    print(f"Switches:")
