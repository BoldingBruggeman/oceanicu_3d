...
case "$role" in
    hpc)
        ...
        echo "  */15 * * * * export OCEANICU_EXPERIMENT_DB=$path/submission_registry.sqlite; export OCEANICU_EXPERIMENT_ROOT_BASE=$path; export OCEANICU_HPC_COMMANDS_DIR=$queue_dir; ( $scripts_dir/bin/pull_experiment_files.sh bb-server1:/data/OceanICU/oceanicu_3d/experiments && $scripts_dir/bin/get-commands-and-update-registry --pull-from bb-server1:/data/OceanICU/oceanicu_3d/experiments/hpc_commands ) >> $queue_dir/get_commands_and_update_registry.log 2>&1"
        ...
        echo "  exports above. Replace $scripts_dir if it was left as a placeholder."
